                                ...
                                <div class="category-bar">
                                        ...
                                        <div class="category-box">
                                                ...
                                                <div class="category-info">
                                                        ...
                                                        <a href="{relative_path}/category/{categories.slug}" itemprop="url">
                                                        <!-- ENDIF categories.link-->
                                                                <h4><!-- IF categories.icon --><i class="fa {categories.icon}"></i> <!-- ENDIF categories.icon -->{categories.na$
                                                        </a>
                                                        <div class="description" itemprop="description">{categories.description}
                                                        <!-- IF !categories.link -->
                                                <!-- IF !categories.link -->
                                                        <div class="pull-right"><span class="badge {categories.unread-class}"><i class="fa fa-book" data-toggle="tooltip" title=$
                                                        <!-- ENDIF !categories.link -->
                                                        </div>
                                                </div>
