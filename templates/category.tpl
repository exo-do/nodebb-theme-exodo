...
<div class="category">
	...
	<div class="category-head-middle clearfix <!-- IF config.usePagination --> headup <!-- ENDIF config.usePagination -->">
		...
		<div class="pull-left category-buttons-right">
			...
			<a href="#!" onclick="showHideFilters()"><span class="btn-group"><button class="btn btn-exodo"><span class="hiden-xs">Filtros</span><span class="exright"><i class="fa fa-filter"></i></span></button></span></a>
			</br>
			</br>
