<div class="topic">
	<div class="topic-head">
		...
		<div class="text-center topic-head-top hidden-xs">
			<h1><a component="post/header" class="topic-title" itemprop="name" title="{title}" href="/topic/{slug}"><i class="fa fa-thumb-tack hide"></i> <i class="fa fa-lock hide"></i>{title}</a></h1>
		</div>
		...
		<div class="topic-head-middle clearfix<!-- IF config.usePagination --> headup <!-- ENDIF config.usePagination -->">
			<div class="pull-left topic-buttons-right">
				...
				<button component="topic/reply" class="btn post_reply btn-exodo<!-- IF !privileges.topics:reply --> disabled<!-- ENDIF !privileges.topics:reply -->">[[topic:reply]]<span>+</span></button>
				</span>
				<span class="btn-group visible-xs">
				<button component="topic/reply" class="btn btn-sm btn-default btn-exodin post_reply<!-- IF !privileges.topics:reply --> disabled<!-- ENDIF !privileges.topics:reply -->"><i class="fa fa-plus"></i></button>
				</span>
			...
			<div class="post-wrapper">
				...
				<div class="topic-buttons clearfix">
					...
					<div class="pull-left hidden-xs">
						...
						<!-- IF !posts.selfPost -->
						<div class="btn-group">
							<button component="post/flag" class="btn btn-sm btn-link flag" type="button" title="[[topic:flag_title]]"><i class="fa fa-exclamation-triangle">	<!-- IF posts.display_moderator_tools -->
					...
					<div class="visible-xs">
											...
											<div class="btn-group pull-right">
												...
												<ul class="dropdown-menu">
														...
														<!-- IF posts.display_moderator_tools -->
														<li> <a component="post/edit" class="pointer edit" title="[[topic:edit]]"><i class="fa fa-pencil"></i> Editar</a></li>
														<!-- IF privileges.editable -->
														<li> <a component="post/delete" class="pointer delete" title="[[topic:delete]]"><i class="fa fa-trash-o"></i> Borrar</a></li>
														<li> <a component="post/purge" class="pointer purge <!-- IF !posts.deleted -->none<!-- ENDIF !posts.deleted -->" title="[[topic:purge]]"><i class="fa fa-eraser"></i> Purgar</a></li>
														...
														<!-- IF !posts.selfPost -->
														<li><a component="post/flag" class="pointer flag" title="[[topic:flag_title]]"><i class="fa fa-exclamation-triangle"> Reportar
																<!-- IF posts.display_moderator_tools -->
																<span style="color:red; font-weight:bold;"> {posts.flags}</span>
																<!-- ENDIF posts.display_moderator_tools -->
														</i></a></li>	
												...
												<button component="post/quote" class="btn btn-sm btn-default btn-exodin quote" type="button">
													<span><i class="fa fa-quote-left"></i></span>
												</button>
												<button component="post/reply" class="btn btn-sm btn-default btn-exodin post_reply" type="button">
					...
					<div class="pull-right hidden-xs">
						...
						<div class="btn-group">
							<!-- IF !posts.index -->
							<button component="topic/follow" class="btn btn-sm btn-link follow" type="button" title="[[topic:notify_me]]">
								<!-- IF isFollowing -->
						...
						<!-- IF privileges.topics:reply -->
						<div class="btn-group">
							<button component="post/quote" class="btn btn-sm btn-link quote" type="button"><i class="fa fa-quote-left"></i> <label> [[topic:quote]] </label></button>
						</div>

						<div class="btn-group">
							<button component="post/reply" class="btn btn-sm btn-link post_reply" type="button"><i class="fa fa-reply"></i> <label> [[topic:reply]]</label></button>
						</div>
						<!-- ENDIF privileges.topics:reply -->
					</div>
	...
	<div class="topic-foot">
		<div class="topic-head-middle clearfix <!-- IF config.usePagination --> headdown <!-- ENDIF config.usePagination -->">
			<div class="pull-left topic-buttons-right">
				...
				<span class="btn-group visible-xs">
				<button component="topic/reply" class="btn btn-group btn-sm btn-default btn-exodin post_reply<!-- IF !privileges.topics:reply --> disabled<!-- ENDIF !privileges.topics:reply -->"><i class="fa fa-plus"></i></button>
				</span>
				<!-- IMPORT partials/thread_sort.tpl -->
			</div>
